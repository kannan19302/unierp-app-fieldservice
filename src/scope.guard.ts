...
/**
 * Enforces the token's scopes per HTTP method: reads need "field-service:read",
 * mutations need "field-service:write". Core embeds these from the bundle manifest's
 * service.scopes (#1).
 */
@Injectable()
